...
//they do not want the guard to notice them.
//In order to achieve this the height of each of the friends should not exceed h.
//If the height of some person is greater than h he can bend down and then
//he surely won't be noticed by the guard.
...
//so they would like to walk in a single row. What is the minimum width of the road,
